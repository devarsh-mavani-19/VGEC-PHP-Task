        ...
        if (mysqli_error($con)) {
            ...
            if (mysqli_num_rows($res) != 0) {
                ...
                if (mysqli_error($con)) {
                    ...
                    $insert = "insert into users(id, name, education, dob, hobby, food) values('" . $id . "', '" . $name . "', '" . $education . "', '" . $dob . "', '', '')";
                    $res = mysqli_query($con, $insert);
                    if (mysqli_error($con)) {
                        echo "<script>alert('Something went wrong')</script>";
                    } else {
    ...
    <div class='container d-flex flex-column justify-content-center align-items-center min-vh-100 form'>
        ...
        <form class='w-50' method="POST">
            ...
            <div class="form-floating">
                <textarea name='education' class="form-control" placeholder="Leave a comment here" id="floatingTextarea"></textarea>
                <label for="floatingTextarea">Education</label>
            </div>
            <div class="mb-3">
